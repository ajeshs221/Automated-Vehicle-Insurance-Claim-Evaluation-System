    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(det.equalsIgnoreCase("")|| det.length()>10)
                {
                    e1.setError("Enter the vehicle number");
                    e1.setFocusable(true);
                }
                else if(date.equalsIgnoreCase("")|| date.length()>20)
                {
                    e2.setError("Enter the chassis number");
                    e2.setFocusable(true);
                }
                else if(ifsc.equalsIgnoreCase("")|| ifsc.length()>15)
                {
                    e3.setError("Enter the engine number");
