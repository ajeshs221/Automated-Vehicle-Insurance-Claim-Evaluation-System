...
public class MyDamagerequest extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView l1;
    String[] vehicleimage,vehicleimage1,vehicleimage2,vnum, price, date,statu,value,damagerequest_id;
        ...
        try {
            ...
            if (status.equalsIgnoreCase("success")) {
                ...
                for (int i = 0; i < ja1.length(); i++) {
                    ...
                    vnum[i] = ja1.getJSONObject(i).getString("vechilenum");
                ...
                Custimage1 a=new Custimage1(this,vehicleimage,price,statu,date,vnum);
                l1.setAdapter(a);
            }
