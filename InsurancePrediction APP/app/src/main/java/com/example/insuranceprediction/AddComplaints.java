...
public class AddComplaints extends AppCompatActivity implements JsonResponse {
    EditText e1;
    Button b1;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JR.json_response = (JsonResponse) AddComplaints.this;
                String q ="/agent_send_complaint?&login_id="+Login.logid+"&complaint="+complaint;
                q = q.replace(" ","%20");
                JR.execute(q);
            }
        });
